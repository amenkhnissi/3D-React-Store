...
const Cart = ({ cart, updateCart, removeFromCart, emptyCart }) => {
  ...
  const IsEmpty = () => (
    ...
    >
      <h1>
        Your shopping cart is empty ! Go shopping Now{" "}
        <Link
          to="/products"
      ...
      {cart.total_items !== 0 ? (
        <>
          <div class="container cart p-1">
            <div
              class="row cart-flex  d-flex justify-content-center "
                    ...
                    {cart.line_items.map((item) => (
                      <div class="row" key={item.id}>
                        <div class="col-lg-3 col-md-12 mb-4 mb-lg-0">
                          ...
                          >
                            <img src={item.media.source} class="w-100 h-100" />
                            <a href="#!">
                              <div
                                class="mask"
                                style={{
